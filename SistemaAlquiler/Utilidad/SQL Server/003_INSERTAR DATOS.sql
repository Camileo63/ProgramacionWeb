...
insert into USUARIO(Nombres,Apellidos,Correo,Contrasena,EsAdministrador) values ('test','cliente','cliente@example.com','cliente123',0)
...
Modelo tarjeta de video: Graficos AMD Radeon
Tama de la pantalla: 15.6 pulgadas
Disco duro sido: 512GB
Nuleos del procesador: Hexa Core',2,1,'2500','60','~/Imagenes/Productos/2.jpg')


insert into PRODUCTO(Nombre,Descripcion,IdMarca,IdCategoria,Precio,Stock,RutaImagen) values('Televisor 65 4K Ultra HD Smart TV 65UN7100PSA.AWF','Tama de la pantalla: 65 pulgadas
Resoluci: 4K Ultra HD
Tecnologia: LED
Conexi Bluetooth: S・Entradas USB: 2',3,1,'3000','120','~/Imagenes/Productos/3.jpg')

insert into PRODUCTO(Nombre,Descripcion,IdMarca,IdCategoria,Precio,Stock,RutaImagen) values('Televisor 50 4K Ultra HD Smart Android','Tama de la pantalla: 50 pulgadas
Resoluci: 4K Ultra HD
Tecnologia: LED
Conexi Bluetooth: S・Entradas USB: 2',4,1,'3200','70','~/Imagenes/Productos/4.jpg')
insert into PRODUCTO(Nombre,Descripcion,IdMarca,IdCategoria,Precio,Stock,RutaImagen) values('Cara Reflex EOS Rebel T100','',5,1,'1560','90','~/Imagenes/Productos/5.jpg')
...
insert into PRODUCTO(Nombre,Descripcion,IdMarca,IdCategoria,Precio,Stock,RutaImagen) values('Mesa de Comedor Donatello','Ancho/Di疥etro: 90 cm
Largo: 150 cm
Alto: 75 cm
N伹ero de puestos: 6
Material de la base: Madera',7,2,'400','90','~/Imagenes/Productos/7.jpg')
insert into PRODUCTO(Nombre,Descripcion,IdMarca,IdCategoria,Precio,Stock,RutaImagen) values('Colch Polaris 1 Plz + 1 Almohada + Protector','Nivel de confort: Intermedio
Tama: 1 plz
Tipo de estructura: Acero
Relleno del colch: Resortes
Material del tapiz: Jacquard',8,3,'500','120','~/Imagenes/Productos/8.jpg')
insert into PRODUCTO(Nombre,Descripcion,IdMarca,IdCategoria,Precio,Stock,RutaImagen) values('Juegos de Sanas 180 Hilos Solid','1.5 PLAZAS',6,3,'200','130','~/Imagenes/Productos/9.jpg')
...
Tama: Peque',9,3,'120','50','~/Imagenes/Productos/11.jpg')
...
insert into PRODUCTO(Nombre,Descripcion,IdMarca,IdCategoria,Precio,Stock,RutaImagen) values('Bicicleta Montara Best Inka Aro 29 Roja','NINGUNO',11,4,'890','75','~/Imagenes/Productos/13.jpg')
...
insert into PRODUCTO(Nombre,Descripcion,IdMarca,IdCategoria,Precio,Stock,RutaImagen) values('Set de Juego Hot Wheels Robo Tibur','NINGUNO',16,7,'130','70','~/Imagenes/Productos/19.jpg')
insert into PRODUCTO(Nombre,Descripcion,IdMarca,IdCategoria,Precio,Stock,RutaImagen) values('Lego 10713 Set Classic: Malet Creativo','NINGUNO',17,7,'110','60','~/Imagenes/Productos/20.jpg')
...
Capacidad total 偀il: 295 lt
Dispensador de agua: S・Ice maker interior: S・Material de las bandejas: Vidrio templado',18,8,'2100','90','~/Imagenes/Productos/21.jpg')
...
Modelo: RI-100BL
Tipo: Frigobar
Eficiencia energica: A
Capacidad total il: 92 lt',20,8,'940','78','~/Imagenes/Productos/23.jpg')
...
Modo: Fr',21,8,'1700','56','~/Imagenes/Productos/24.jpg')
...
Tecnolog: No inverter
Dimensiones (AltoxAnchoxProfundidad): 100cmx62cmx61cm',22,8,'2800','48','~/Imagenes/Productos/25.jpg')
insert into PRODUCTO(Nombre,Descripcion,IdMarca,IdCategoria,Precio,Stock,RutaImagen) values('Campana Extractora EJSE202TBJS','Retractil: No
Iluminaci: S・Modelo: EJSE202TBJS
Tipo: Campanas clicas
